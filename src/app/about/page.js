    ...
    return (
        <main className="w-full">
            <section className="w-full flex flex-col gap-4 pv-4">
                <div className="relative w m-auto h bg-n1 rounded-md hidden" style={{"--w": "90%", "--h": "540px"}}>
                    <div className="absolute flex items-end w-full h-full bg-mask z p-4" style={{"--z": "2"}} data-aos="fade-up">
                        <h1 className="uppercase color-white fs-5xl lg:fs-6xl lg:w" style={{"--mxw-lg": "60%"}}>Quienes son Kintu</h1>
                    </div>
            ...
            <section className="w-full pv-8">
                <div className="w m-auto flex flex-row gap-8" style={{"--w": "90%"}}>
                    <div className="w-full">
                        <h2 className="uppercase fs-4xl" data-aos="fade-up-right">Visión, Misión y Valores de <span className="block fw-bolder fs-6xl">Kintu</span></h2>
                        <p className="fs-xl color-gray leading-relaxed" data-aos="fade-up-right">{company?.description}</p>
                    </div>
                    <ul className="w-full flex flex-col gap-4">
                        <li className="w-full">
                            <h3 className="fs-3xl lg:fs-5xl mb-2" data-aos="fade-up">Misión</h3>
                            <p className="color-gray fs-xl leading-relaxed" data-aos="fade-up">{company?.mission}</p>
                        </li>
                        <li className="w-full">
                            <h3 className="fs-3xl lg:fs-5xl mb-2" data-aos="fade-up">Visión</h3>
                            <p className="color-gray fs-xl leading-relaxed" data-aos="fade-up">{company?.vision}</p>
                        </li>
                        <li className="w-full flex flex-col gap-2">
                            <h3 className="fs-3xl lg:fs-5xl" data-aos="fade-up">Valores</h3>
                            <ul className="flex flex-col gap-4 ml-4">
                                {company?.values.map((value, idx) => (
                                    <li key={idx} className="fs-xl color-gray" data-aos="fade-up">- {value}</li>
                                ))}
                            </ul>
                        </li>
                    </ul>
