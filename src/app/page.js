...
import GridHeroSummary from "@/components/GridHeroSummary";
                ...
                <section className="w-full flex flex-col gap-4 pv-4">
                    <div className="relative w m-auto h bg-n1 rounded-md hidden" style={{"--w": "90%", "--h": "540px"}}>
                        <div className="absolute flex items-end w-full h-full bg-mask z p-4" style={{"--z": "2"}} data-aos="fade-up">
                            <h1 className="uppercase color-white fs-5xl lg:fs-6xl lg:w" style={{"--mxw-lg": "60%"}}>DESCUBRE TU AVENTURA</h1>
                        </div>
                        <picture className="inset-0 absolute block w-full h-full">
                            <source srcSet="./hero.jpg" media="(min-width: 640px)" />
                            <source srcSet="./hero.jpg" media="(min-width: 1024px)" />
                            <img src="./hero.jpg" alt={config.HeroAlt} loading="lazy" decoding="async" referrerPolicy="no-referrer" draggable={false} />
                        </picture>
                    </div>
                    <GridHeroSummary/>
                </section>
